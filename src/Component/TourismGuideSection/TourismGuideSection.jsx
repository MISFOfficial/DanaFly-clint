...
const TourismGuideSection = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16">
      <h2 className="text-xl md:text-3xl font-bold text-[#00A99D] mb-8">Tourism & Travel Guide</h2>
              ...
              {packages.map(pkg => (
                <div key={pkg._id} className="bg-white shadow-md rounded-lg overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-lg font-bold text-[#00A99D] mb-2">{pkg.packageName}</h3>
                    <p className="text-gray-700 mb-4">Price: ${pkg.price}</p>

                    <Link to={`/packageDetails/${pkg._id}`}>
                      <button
                        className="px-4 py-2 bg-[#00A99D] text-white rounded-full hover:bg-[#00796b] transition text-sm  md:text-lg"
                      >
                        View Details
                      </button>
                    </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {guides.map(guide => (
                <div key={guide._id} className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold text-[#00A99D] mb-2">{guide.name}</h3>
