...
const Forbidden = () => {
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-red-100 via-red-200 to-red-300">
            <div className="bg-p1 p-10 rounded-3xl shadow-xl max-w-lg text-center animate-fadeIn">
                <div className="text-red-500 text-6xl mb-4">
                    <FaLock />
                </div>
                <h1 className="text-5xl font-bold text-lightmb-4">403</h1>
                <h2 className="text-2xl font-semibold text-light mb-2">Access Forbidden</h2>
